...
* In Github, fork `https://github.com/maxem-io/gowsdl` to your own account
* Get the package using "go get": `go get github.com/maxem-io/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/maxem-io/gowsdl/`
